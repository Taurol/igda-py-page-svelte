    ...
    <nav class="bg-white h-32 lg:hidden">
        <div class="max-w-screen-xl flex flex-row items-center justify-between h-full px-5">
            ...
            <button
                on:click={toggleMenu}
                type="button"
                class="inline-flex items-center justify-center p-2 w-10 h-10 ml-3 text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700"
